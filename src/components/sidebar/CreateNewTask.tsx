  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        w-[90vw] max-w-[450px] rounded-md bg-bg-2 p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_20px_25px_-30px] focus:outline-none
